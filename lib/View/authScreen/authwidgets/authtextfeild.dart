      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
         ...
         // isDense: true,
          ...
          suffixIcon:pass? IconButton(icon: Icon(authController.obscuretext.value? Icons.remove_red_eye_outlined:Icons.remove_red_eye,),onPressed: authController.obscureText,):SizedBox(),
          prefixIcon: Icon(
